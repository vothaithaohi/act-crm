...
export default function EditTalentPage() {
  ...
  return (
    <PermissionGuard
      ...
      customTitle="Chỉnh Sửa Hồ Sơ Diễn Viên"
      customMessage="Quyền chỉnh sửa thông tin nhân trắc học và hồ sơ casting chỉ dành cho Casting Director và Ban Giám Đốc."
    >
      {isLoading ? (
