...
export function Sidebar() {
  ...
  const { leads, talents, resetAllData } = useCRM();
  ...
  const navItems = [
    ...
    },
    {
      ...
      subtitle: 'Lead Pipeline & Meta Ads',
      href: '/leads',
      icon: Users,
      badge: leads.length
    },
    {
      ...
      subtitle: 'Talent Pool & Tuyển vai',
      href: '/talents',
      icon: Sparkles,
    ...
    },
    {
      ...
      subtitle: 'Form 6 bước diễn viên',
      href: '/talents/new',
      icon: UserPlus,
      badge: null
    }
  ...
  return (
    <aside className="w-64 border-r bg-card flex flex-col justify-between h-screen sticky top-0 shrink-0 z-30 select-none">
      <div>
        {/* Brand Header */}
        ...
        {/* Quick Highlights */}
        <div className="px-4 py-3 mx-3 mt-4 rounded-xl bg-muted/50 border border-border/60 text-xs space-y-2">
